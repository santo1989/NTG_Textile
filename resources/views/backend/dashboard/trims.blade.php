...
<body style="background: #263037">
    ...
    <div class="container-fluid text-center text-light">
        ...
        <div class="row mb-3">
            <div class="row ">
                ...
                <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
                    <h2>Trims & Accessories Store Dashboard</h2>
                </div>
        ...
        <table class="table table-bordered  text-center no-wrap text-light">
            ...
            <tbody>
                @foreach ($trims_dashboard as $row)
                    <tr>
                        ...
                        <td>{{ $row->total_issue_qty }}</td>
                        <td>{{ $row->total_in_hand_qty }}</td>
                        <td>{{ $row->rack_no }}</td>
    ...
    <script>
        ...
        function displayNextBatch() {
            ...
            $.each(batchData, function(key, value) {
                ...
                <td>${value.total_issue_qty}</td>
                <td>${value.total_in_hand_qty}</td>
                <td>${value.rack_no}</td>
