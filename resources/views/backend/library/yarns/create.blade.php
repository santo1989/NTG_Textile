<x-backend.layouts.master>
    <x-slot name="pageTitle">
        Create Warehouse Stock Yarns Information
    </x-slot>
    ...
    <x-slot name='breadCrumb'>
        <x-backend.layouts.elements.breadcrumb>
            ...
            <li class="breadcrumb-item active">Create Warehouse Stock Yarns Information</li> --}}
        </x-backend.layouts.elements.breadcrumb>
    </x-slot>


    <x-backend.layouts.elements.errors />
    <form action="{{ route('yarns.store') }}" method="post" enctype="multipart/form-data">
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                @php
                    ...
                    $last_record = App\Models\YarnDashboard::latest()->first();
                    // dd( $last_record);
                ...
                $(document).ready(function() {
                    $('#received_qty').on('input', function() {
                        ...
                        if (!isNaN(received_qty) && !isNaN(last_record_closing_qumilative_qty)) {
                            ...
                            $('#received_qumilative_qty').val(result);
                        } else {
                ...
                $(document).ready(function() {
                    $('#issue_qty').on('input', function() {
                        ...
                        if (!isNaN(issue_qty) && !isNaN(last_record_closing_qumilative_qty)) {
                            ...
                            $('#issue_qumilative_qty').val(result);
                        } else {
