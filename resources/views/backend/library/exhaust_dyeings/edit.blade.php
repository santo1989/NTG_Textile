<x-backend.layouts.master>
    <x-slot name="pageTitle">
        Edit EXHAUST DYEING Production Data Information
    </x-slot>
    ...
    <x-slot name='breadCrumb'>
        <x-backend.layouts.elements.breadcrumb>
            ...
            <li class="breadcrumb-item active">Edit EXHAUST DYEING Production Data Information</li> --}}
        </x-backend.layouts.elements.breadcrumb>
    </x-slot>


    <x-backend.layouts.elements.errors />
    <form action="{{ route('exhaust_dyeings.update', ['exhaust_dyeing' => $exhaust_dyeings->id]) }}" method="post"
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input name="date" type="date" id="date" value="{{ $exhaust_dyeings->date }}"
                        class="form-control">
                </div>
                <div class="col-md-6">
                    <label for="mc_no">M/c No</label>
                    <input type="text" name="mc_no" id="mc_no" class="form-control"
                        value="{{ $exhaust_dyeings->mc_no }}" placeholder="M/c No" required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input name="target_kg" type="number" id="target_kg" class="form-control" placeholder="Target(KG)"
                        value="{{ $exhaust_dyeings->target_kg }}" required>
                </div>
                <div class="col-md-6">
                    ...
                    <input type="number" name="actual_production_kg" id="actual_production_kg" class="form-control"
                        placeholder="Actual production(KG)" value="{{ $exhaust_dyeings->actual_production_kg }}"
                        required>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input id="result" type="text" class="form-control"
                        value="{{ $exhaust_dyeings->achievement }}" readonly>
                </div>
                <div class="col-md-6">
                    <label for="remarks">Remarks</label>
                    <textarea name="remarks" id="remarks" class="form-control" placeholder="Remarks">{{ $exhaust_dyeings->remarks }}</textarea>
                </div>
            </div>
