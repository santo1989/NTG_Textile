<x-backend.layouts.master>
    <x-slot name="pageTitle">
        Create EXHAUST DYEING Production Data
    </x-slot>
    ...
    <x-slot name='breadCrumb'>
        <x-backend.layouts.elements.breadcrumb>
            ...
            <li class="breadcrumb-item active">Create EXHAUST DYEING Production Data</li> --}}
        </x-backend.layouts.elements.breadcrumb>
    </x-slot>


    <x-backend.layouts.elements.errors />
    <form action="{{ route('exhaust_dyeings.store') }}" method="post" enctype="multipart/form-data">
